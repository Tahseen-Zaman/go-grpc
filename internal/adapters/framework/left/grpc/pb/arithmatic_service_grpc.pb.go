...
func (c *arithmeticServiceClient) GetAddition(ctx context.Context, in *OperationParams, opts ...grpc.CallOption) (*Answer, error) {
...
func (c *arithmeticServiceClient) GetSubtraction(ctx context.Context, in *OperationParams, opts ...grpc.CallOption) (*Answer, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Answer)
...
func (c *arithmeticServiceClient) GetMultiplication(ctx context.Context, in *OperationParams, opts ...grpc.CallOption) (*Answer, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Answer)
...
func (c *arithmeticServiceClient) GetDivision(ctx context.Context, in *OperationParams, opts ...grpc.CallOption) (*Answer, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Answer)
...
func (UnimplementedArithmeticServiceServer) GetAddition(context.Context, *OperationParams) (*Answer, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetAddition not implemented")
}
func (UnimplementedArithmeticServiceServer) GetSubtraction(context.Context, *OperationParams) (*Answer, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetSubtraction not implemented")
}
func (UnimplementedArithmeticServiceServer) GetMultiplication(context.Context, *OperationParams) (*Answer, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetMultiplication not implemented")
}
func (UnimplementedArithmeticServiceServer) GetDivision(context.Context, *OperationParams) (*Answer, error) {
...
func _ArithmeticService_GetAddition_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ArithmeticServiceServer).GetAddition(ctx, req.(*OperationParams))
	}
...
func _ArithmeticService_GetSubtraction_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ArithmeticServiceServer).GetSubtraction(ctx, req.(*OperationParams))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _ArithmeticService_GetMultiplication_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ArithmeticServiceServer).GetMultiplication(ctx, req.(*OperationParams))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _ArithmeticService_GetDivision_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ArithmeticServiceServer).GetDivision(ctx, req.(*OperationParams))
	}
	return interceptor(ctx, in, info, handler)
}
